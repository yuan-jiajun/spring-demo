...
> 据网上一些资讯介绍，虽然初始化Spring容器的时候可以在Bean工厂和应用上下文中任选一种，但是Bean工厂这种做法对一般应用来说太低级了，因此应用上下文的方式相对于Bean工厂来说更受程序员欢迎（也许不仅仅是这个理由呢，嗯哼╭(╯^╰)╮）。
...
## 4. Spring版本与历史
虽然Spring 3.x现在基本上已经没人用了，但是建议大家还是对这些来龙去脉了解一下好，要不然怎么出去吹水？
